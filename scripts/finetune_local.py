...
"""
Local LoRA fine-tune on Meghan's cover letter corpus.
...
OLLAMA_NAME     = "meghan-cover-writer"

SYSTEM_PROMPT = (
    "You are Meghan McCann's personal cover letter writer. "
    "Write professional, warm, and results-focused cover letters in Meghan's voice. "
...
print(f"\n{'='*60}")
print(f"  Meghan Cover Letter Fine-Tuner")
